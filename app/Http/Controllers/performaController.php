...
// Fetch absensici data
    ...
    $absensiciData = $absensiciQuery->paginate(100);
...
//     $query = DB::connection('mysql')->table('absensici')
//         ->leftJoin('users as user1', 'absensici.npk', '=', DB::raw('user1.npk'))
...
//         })
//         ->join(DB::connection('mysql2')->table('pcd_master_users as pcd_users'), function ($join) {
