...
@section('content')
    <div class="container-fluid">
        <div class="content-wrapper">
            <div class="p-3">
                <p class="pl-3 pb-3 font-weight-bold h3">Daftar Readlist</p>
            ...
            function loadBuku(page) {
                $.ajax({
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card" data-buku-id="${buku.buku_id}" style="cursor: pointer;">
                ...
                `;
                        ...
                        $('.card').click(function() {
                            var bukuId = $(this).data('buku-id'); // Ambil ID dari data-buku-id
